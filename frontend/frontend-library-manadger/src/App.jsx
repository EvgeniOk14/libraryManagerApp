...
//         <Router>
//             <div>
//                 <h1>Система управление библиотекой:</h1>
//
//                 {/* Компонент уведомлений */}
//                 <NotificationComponent /> {/* Добавляем компонент уведомлений здесь */}
//
...
//                     <ul>
//                         <li>
//                             <Link to="/add-item">Добавить предмет в библиотеку</Link> {/* Ссылка на AddItemForm */}
//                         </li>
//                         <li>
//                             <Link to="/borrow-book">Взять предмет на прокат из библиотеки</Link> {/* Ссылка на BorrowBookForm */}
//                         </li>
//                         <li>
//                             <Link to="/register">Регистрация пользователя в библиотеке</Link> {/* Ссылка на RegisterForm */}
//                         </li>
//                         <li>
//                             <Link to="/return-book">Возврат предмета в библиотеку</Link> {/* Ссылка на ReturnBookForm */}
//                         </li>
//                     </ul>
//                 </nav>
//
